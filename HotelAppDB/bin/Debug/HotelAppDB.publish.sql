...
begin
insert into dbo.RoomTypes(Title, Description)                               -- 1b. SQL-query die starter data insert in de 'RoomTypes' tabel.
values('King Size Bed', 'A room with a king-size bed and a window.'),
('Two Queen Size Beds', 'A room with two queen-sized beds and a window.'),
